    ...
    namespace Graphics
    {
        ...
        public class RenderWindow : SFML.Window.Window, RenderTarget
        {
            ...
            public override ContextSettings Settings
            {
                get
                {
                    return sfRenderWindow_getSettings ( CPointer );
                }
            }
            ...
            public override Vector2i Position
            {
                get
                {
                    return sfRenderWindow_getPosition ( CPointer );
                }
                set
                {
                    sfRenderWindow_setPosition ( CPointer, value );
                }
            }
            ...
            public override Vector2u Size
            {
                get
                {
                    return sfRenderWindow_getSize ( CPointer );
                }
                set
                {
                    sfRenderWindow_setSize ( CPointer, value );
                }
            }
            ...
            public override IntPtr SystemHandle
            {
                get
                {
                    return sfRenderWindow_getSystemHandle ( CPointer );
                }
            }
            ...
            [DllImport ( Constants.GraphicsDLL, CallingConvention = CallingConvention.Cdecl ), SuppressUnmanagedCodeSecurity]
